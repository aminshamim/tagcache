    ...
    <div className="flex h-full">
      <aside className="w-20 flex flex-col items-center py-6 gap-6 bg-brand-primary text-white">
        ...
        <nav className="flex flex-col gap-4">
          ...
          <NavLink to="/ui/search" className={({ isActive }) => `w-12 h-12 flex items-center justify-center rounded-xl ${isActive ? 'bg-white/20' : 'hover:bg-white/10'} transition-colors`}>
          ...
          {/* stats nav removed */}
          <NavLink to="/ui/tags" className={({ isActive }) => `w-12 h-12 flex items-center justify-center rounded-xl ${isActive ? 'bg-white/20' : 'hover:bg-white/10'} transition-colors`}>
          ...
          <NavLink to="/ui/put" className={({ isActive }) => `w-12 h-12 flex items-center justify-center rounded-xl ${isActive ? 'bg-white/20' : 'hover:bg-white/10'} transition-colors`}>
        ...
        <main className="flex-1 bg-gray-50 overflow-hidden flex">
          <div className="flex-1 p-6 overflow-auto">
            <Routes>
              ...
              <Route path="/ui/dashboard" element={<Navigate to="/" replace />} />
              <Route path="/ui/put" element={<PutPage />} />
              <Route path="/ui/tags" element={<TagsPage />} />
              {/* /stats route removed */}
